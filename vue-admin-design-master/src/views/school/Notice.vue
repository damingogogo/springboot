    ...
    <el-card shadow="always">
      ...
      >
        ...
        <el-form-item label="性别">
          <el-input v-model="listQuery.sex" placeholder="性别"/>
        </el-form-item>
      ...
      >
        ...
        <el-table-column prop="marry" label="婚姻状况" align="center" width="100">
          <!-- <template slot-scope="scope">
        ...
        <el-table-column prop="vaccine" label="疫苗" width="50"></el-table-column>
        ...
        <el-table-column prop="address" label="家庭住址" align="center" width="150" show-overflow-tooltip/>
      ...
      >
        ...
        >
          ...
          <el-form-item label="工号：" prop="jobNumber">
            <el-input v-model="dialogForm.jobNumber"/>
          </el-form-item>

          <el-form-item label="性别：" prop="sex">
            <el-input v-model="dialogForm.sex"/>
          </el-form-item>
          ...
          <el-form-item label="婚姻：" prop="marry">
            <el-input v-model="dialogForm.marry"/>
          </el-form-item>
          <el-form-item label="疫苗：" prop="vaccine">
            <el-input v-model="dialogForm.vaccine"/>
          </el-form-item>
          ...
          </el-form-item> <!-- <el-form-item label="婚姻状况：" prop="married">
      ...
      >
        ...
        >
          <el-form-item label="姓名：" prop="name">
            <el-input v-model="dialogForm1.name"/>
          </el-form-item>
          <el-form-item label="工号：" prop="jobNumber">
            <el-input v-model="dialogForm1.jobNumber"/>
          </el-form-item>
          <el-form-item label="性别：" prop="sex">
            <el-input v-model="dialogForm1.sex"/>
          </el-form-item>
          <el-form-item label="年龄：" prop="age">
            <el-input v-model="dialogForm1.age"/>
          </el-form-item>
          <el-form-item label="手机：" prop="phone">
            <el-input v-model="dialogForm1.phone"/>
          </el-form-item>
          <el-form-item label="婚姻：" prop="marry">
            <el-input v-model="dialogForm1.marry"/>
          </el-form-item>
          <el-form-item label="疫苗：" prop="vaccine">
            <el-input v-model="dialogForm1.vaccine"/>
          </el-form-item>
          <el-form-item label="爱好：" prop="hobby">
            <el-input v-model="dialogForm1.hobby"/>
          </el-form-item>
          <el-form-item label="地址：" prop="address">
            <el-input v-model="dialogForm1.address"/>
          </el-form-item>
          <div class="footer-item">
...
export default {
  ...
  mounted() {
    //渲染表格数据
    const that = this
    this.$axios.get("http://localhost:8086/teacher/select", {})
  ...
  methods: {
    ...
    add() {
      ...
      this.$axios.post("http://localhost:8086/teacher/add", this.dialogForm
      )
        .then(function (response) {
          console.log(response);
    ...
    update() {
      ...
      this.$axios.post("http://localhost:8086/teacher/update", this.dialogForm1
      )
        .then(function (response) {
          console.log(response);
    ...
    del(id) {
      ...
      this.$axios.post("http://localhost:8086/teacher/delete" + id, {}
      )
        .then(function (response) {
          console.log(response);
          alert("删除成功")
