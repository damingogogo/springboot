    ...
    <el-card shadow="always">
      ...
      >
        <el-form-item label="学校名称">
          <el-input v-model="listQuery.name" placeholder="学校名称"/>
        </el-form-item>
        <el-form-item label="学校地址">
          <el-input v-model="listQuery.address" placeholder="学校地址"/>
        </el-form-item>
      ...
      >
        ...
        <el-table-column prop="master" label="校长姓名"/>
        <el-table-column prop="address" label="学校地址"/>
        <el-table-column prop="numberStudent" label="学校人数"/>

        <el-table-column prop="numberGrade" label="学校年级数量"/>
        <el-table-column prop="numberClass" label="学校班级数量"/>
        <el-table-column prop="detail" label="学校描述" show-overflow-tooltip/>
      ...
      >
        ...
        >
          ...
          <el-form-item label="学生总人数" style="width: 100px;">
            <el-input v-model="dialogForm.numberStudent"></el-input>
          </el-form-item>
          <el-form-item label="学校地址">
            <el-input v-model="dialogForm.address"></el-input>
          </el-form-item>
          <el-form-item label="年级总数量">
            <el-input v-model="dialogForm.numberGrade"></el-input>
          </el-form-item>
          <el-form-item label="班级总数量">
            <el-input v-model="dialogForm.numberClass"></el-input>
          </el-form-item>
      ...
      >
        ...
        >
          ...
          <el-form-item label="学生总人数">
            <el-input v-model="dialogForm1.numberStudent"></el-input>
          </el-form-item>
          <el-form-item label="学校地址">
            <el-input v-model="dialogForm1.address"></el-input>
          </el-form-item>
          <el-form-item label="年级总数量">
            <el-input v-model="dialogForm1.numberGrade"></el-input>
          </el-form-item>
          <el-form-item label="班级总数量">
            <el-input v-model="dialogForm1.numberClass"></el-input>
          </el-form-item>
...
export default {
  ...
  mounted() {
    //渲染表格数据
    const that = this
    this.$axios.get("http://localhost:8086/school/select", {})
  ...
  methods: {
    ...
    add() {
      ...
      this.$axios.post("http://localhost:8086/school/add", this.dialogForm
      )
        .then(function (response) {
          console.log(response);
    ...
    update() {
      ...
      this.$axios.post("http://localhost:8086/school/update", this.dialogForm1
      )
        .then(function (response) {
          console.log(response);
    ...
    del(id) {
      ...
      this.$axios.post("http://localhost:8086/school/delete" + id, {}
      )
        .then(function (response) {
          console.log(response);
          alert("删除成功")
    ...
    search() {
      ...
      this.$axios.post("http://localhost:8086/school/search", form)
        .then(function (response) {
