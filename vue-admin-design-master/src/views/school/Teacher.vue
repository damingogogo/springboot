    ...
    <el-card shadow="always">
      ...
      >
        ...
        <!-- <el-table-column prop="marry" label="婚姻状况" align="center" width="100">
         ...
         <el-table-column prop="vaccine" label="疫苗" width="190"></el-table-column>
       ...
       <!-- <el-table-column label="禁止编辑" align="center">
        ...
        <el-table-column prop="hobby" label="爱好" width="140" show-overflow-tooltip ></el-table-column>
...
getii(row) {
  const that = this
    ...
    update() {
        ...
        form.append('sex', this.listQuery.sex)
        form.append('phone', this.listQuery.phone)
        this.$axios.post("http://localhost:8086/teacher/search", form)
          .then(function (response) {
