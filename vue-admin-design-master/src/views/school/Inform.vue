    ...
    <el-card shadow="always">
      ...
      >
        ...
        <el-form-item label="内容">
          <el-input v-model="listQuery.detail" placeholder="内容"/>
        </el-form-item>
      ...
      >
        ...
        <el-table-column prop="time" label="发布时间" how-overflow-tooltip>
        </el-table-column>

        <el-table-column prop="people" label="发布人" how-overflow-tooltip>
        </el-table-column>

        <el-table-column prop="picture" label="图片" how-overflow-tooltip>
        </el-table-column>

        <el-table-column prop="detail" label="内容" align="center" width="200">
      ...
      >
        ...
        >
          ...
          <el-form-item label="发布人" prop="people">
            <el-input v-model="dialogForm.people"/>
          </el-form-item>
          <el-form-item label="图片" prop="picture">
            <el-input v-model="dialogForm.picture"/>
          </el-form-item>
          <el-form-item label="内容" prop="detail">
            <el-input v-model="dialogForm.detail"/>
          </el-form-item>
      ...
      >
        ...
        >
          <el-form-item label="标题：" prop="title">
            <el-input v-model="dialogForm1.title"/>
          </el-form-item>
          <el-form-item label="发布时间" prop="time">
            <el-input v-model="dialogForm1.time"/>
          </el-form-item>
          <el-form-item label="发布人" prop="people">
            <el-input v-model="dialogForm1.people"/>
          </el-form-item>
          <el-form-item label="图片" prop="picture">
            <el-input v-model="dialogForm1.picture"/>
          </el-form-item>
          <el-form-item label="内容" prop="detail">
            <el-input v-model="dialogForm1.detail"/>
          </el-form-item>
          <div class="footer-item">
...
export default {
  ...
  mounted() {
    //渲染表格数据
    const that = this
    this.$axios.get("http://localhost:8086/notice/select", {})
  ...
  methods: {
    ...
    add() {
      ...
      this.$axios.post("http://localhost:8086/notice/add", this.dialogForm
      )
        .then(function (response) {
          console.log(response);
    ...
    update() {
      ...
      this.$axios.post("http://localhost:8086/notice/update", this.dialogForm1
      )
        .then(function (response) {
          console.log(response);
    ...
    del(id) {
      ...
      this.$axios.post("http://localhost:8086/notice/delete" + id, {}
      )
        .then(function (response) {
          console.log(response);
          alert("删除成功")
    ...
    search() {
      ...
      form.append('detail', this.listQuery.detail)
      this.$axios.post("http://localhost:8086/notice/search", form)
        .then(function (response) {
