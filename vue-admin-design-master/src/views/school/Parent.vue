...
<el-form-item label="政治面貌">
  <el-input v-model="dialogForm.politic"></el-input>
</el-form-item>
...
<el-form-item label="性别：" prop="sex">
            ...
            <el-select v-model="dialogForm1.sex">
              <el-option :value="'男'" label="男" />
              <el-option :value="'女'" label="女" />
            </el-select>
          </el-form-item>
...
<el-form-item label="政治面貌">
  <el-input v-model="dialogForm1.politic"></el-input>
</el-form-item>
<el-form-item label="地址">
...
export default {
  ...
  created() {
      ...
      mounted() {
        ...
        //渲染表格数据
        const that = this
        this.$axios.get("http://localhost:8086/parent/select", {
        })
...
getii(row) {
  const that = this
    ...
    add() {
              ...
              this.$axios.post("http://localhost:8086/parent/add", this.dialogForm
              )
                .then(function (response) {
                  console.log(response);
    ...
    update() {
           ...
           this.$axios.post("http://localhost:8086/parent/update", this.dialogForm1
           )
             .then(function (response) {
               console.log(response);
         ...
         del(id){
             ...
             //  const id = scope.row.id
              this.$axios.post("http://localhost:8086/parent/delete"+id, {}
              )
                .then(function (response) {
                  console.log(response);
                  alert("删除成功")
        ...
        form.append('phone', this.listQuery.phone)
        this.$axios.post("http://localhost:8086/parent/search", form)
          .then(function (response) {
