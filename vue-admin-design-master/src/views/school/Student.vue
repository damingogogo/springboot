  ...
  <div class="table-classic-wrapper">
    <el-card shadow="always">
      ...
      <div class="control-btns">
        ...
        <el-button type="danger" slot="reference" @click="batchDelete">批量删除</el-button>
      </div>
      <!-- 查询栏 -->
      <el-form
        ref="searchForm"
      ...
      >
        ...
        <el-form-item label="年龄">
          <el-input v-model="listQuery.age" placeholder="年龄"/>
        </el-form-item>
...
<!--        <el-table-column prop="sex" label="性别"/>-->
        <el-table-column prop="sex" label="性别" style="margin-left: 25px;">
          <template slot-scope="scope">
            <el-tag size="big" hit="true" type="success">{{scope.row.sex}}</el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="politic" label="政治面貌" align="center">
        </el-table-column>
        ...
        <el-table-column prop="hobby" label="爱好" width="80"></el-table-column>
        <el-table-column prop="createTime" label="创建时间" how-overflow-tooltip>
        </el-table-column>
        <el-table-column label="操作" align="center" width="200">
          <template slot-scope="scope">
            <el-button type="warning" @click="getii(scope.row)">编辑</el-button>
            <!--            <el-button type="danger" @click="del(scope.row.id)">删除</el-button>-->
            <el-button type="primary" @click="open(scope.row.id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页栏 -->
      ...
      >
        ...
        >
          ...
          <el-form-item label="身份证" prop="idnumber" >
            <el-input v-model="dialogForm.idnumber"></el-input>
          </el-form-item>
          <el-form-item label="年龄" prop="age">
            <el-input v-model="dialogForm.age"></el-input>
          </el-form-item>
          <el-form-item label="身高" prop="height">
            <el-input v-model="dialogForm.height"></el-input>
          </el-form-item>
          ...
          <el-form-item label="政治面貌：" prop="politic">
            <el-radio-group v-model="dialogForm.politic">
              <el-radio :value="'中共党员'" label="中共党员">中共党员</el-radio>
              <el-radio :value="'群众'" label="群众">群众</el-radio>
              <el-radio :value="'共青团员'" label="共青团员">共青团员</el-radio>
              <el-radio :value="'其他'" label="其他">其他</el-radio>
            </el-radio-group>
          </el-form-item>
          ...
          <el-form-item label="爱好" prop="hobby">
            <el-input v-model="dialogForm.hobby"></el-input>
          </el-form-item>
      ...
      >
        ...
        >
          <el-form-item label="姓名" prop="name">
            <el-input v-model="dialogForm1.name"></el-input>
          </el-form-item>
          <el-form-item label="性别：" prop="sex">
            <el-radio-group v-model="dialogForm1.sex">
              <el-radio :value="'男'" label="男">男</el-radio>
              <el-radio :value="'女'" label="女">女</el-radio>
            </el-radio-group>
          </el-form-item>
          <el-form-item label="身份证" prop="idnumber" >
            <el-input v-model="dialogForm1.idnumber"></el-input>
          </el-form-item>
          <el-form-item label="年龄" prop="age">
            <el-input v-model="dialogForm1.age"></el-input>
          </el-form-item>
          <el-form-item label="身高" prop="height">
            <el-input v-model="dialogForm1.height"></el-input>
          </el-form-item>
          <el-form-item label="体重" prop="weight">
            <el-input v-model="dialogForm1.weight"></el-input>
          </el-form-item>
          <el-form-item label="民族" prop="nation">
            <el-input v-model="dialogForm1.nation"></el-input>
          </el-form-item>
          <el-form-item label="政治面貌：" prop="politic">
            <el-radio-group v-model="dialogForm1.politic">
              <el-radio :value="'中共党员'" label="中共党员">中共党员</el-radio>
              <el-radio :value="'群众'" label="群众">群众</el-radio>
              <el-radio :value="'共青团员'" label="共青团员">共青团员</el-radio>
              <el-radio :value="'其他'" label="其他">其他</el-radio>
          ...
          <el-form-item label="爱好" prop="hobby">
            <el-input v-model="dialogForm1.hobby"></el-input>
          </el-form-item>
          <el-form-item label="创建时间" prop="createTime">
            <el-col :span="11">
...
export default {
  ...
  mounted() {
    ...
    form.append('age', this.listQuery.age)
    form.append('address', this.listQuery.address)
    this.$axios.post("http://localhost:8086/student/page", form)
  ...
  methods: {
    ...
    add() {
      ...
      this.$axios.post("http://localhost:8086/student/add", this.dialogForm
      )
        .then(function (response) {
    ...
    update() {
      ...
      this.$axios.post("http://localhost:8086/student/update", this.dialogForm1
      )
        .then(function (response) {
          console.log(response);
    ...
    del(id) {
      ...
      this.$axios.post("http://localhost:8086/student/delete" + id, {}
      )
        .then(function (response) {
          console.log(response);
          // alert("删除成功")
    ...
    batchDelete(val) {
      const that = this
      let ids = that.multipleSelection.map(val => val.id)
      console.log(ids)
      if (this.multipleSelection.length < 1) {
        ...
        this.$confirm('此操作将删除选中数据, 是否继续?', '提示', {
          ...
          this.$axios.post("http://localhost:8086/student/delete/batch", ids, {}
          )
            .then(function (response) {
              console.log(response);
              // alert("删除成功")
    ...
    exportTable(type) {
      if (this.tableData.length) {
        const params = {
          header: ['姓名', '性别', '身份证号', '年龄', '身高', '体重', '民族', '政治面貌', '住址', '手机', '爱好', '创建时间'],
          key: ['name', 'sex', 'idnumber', 'age', 'height', 'weight', 'nation', 'politic', 'address', 'phone', 'hobby', 'createTime'],
          data: this.tableData,
          autoWidth: true,
          fileName: '综合表格',
          bookType: type
