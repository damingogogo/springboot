 ...
 export default {
   ...
   created() {
       ...
       mounted() {
         //渲染表格数据
         const that = this
         this.$axios.get("http://localhost:8086/user1/select", {
         })
 ...
 getii(row) {
   const that = this
     ...
     add() {
               ...
               this.$axios.post("http://localhost:8086/user1/add", this.dialogForm
               )
                 .then(function (response) {
                   console.log(response);
     ...
     update() {
            ...
            this.$axios.post("http://localhost:8086/user1/update", this.dialogForm1
            )
              .then(function (response) {
                console.log(response);
          ...
          del(id){
              ...
              //  const id = scope.row.id
               this.$axios.post("http://localhost:8086/user1/delete"+id, {}
               )
                 .then(function (response) {
                   console.log(response);
                   alert("删除成功")
         ...
         this.$axios.post("http://localhost:8086/user1/search", form)
           .then(function (response) {
