...
<template>
      ...
      <el-card shadow="always">
        ...
        >
          <el-form-item label="投票标题">
            <el-input v-model="listQuery.title" placeholder="投票标题" />
          </el-form-item>
        ...
        >
          ...
          <el-table-column prop="title" label="投票主题" align="center">
          ...
          <el-table-column prop="createBy" label="投票发起人" />
          <el-table-column prop="annoymous" label="是否匿名" />
          <el-table-column prop="num" label="被投总票数" />
  ...
  <el-form-item label="图片">
    <el-input v-model="dialogForm.imgUrl"></el-input>
  </el-form-item>
  <el-form-item label="投票发起人">
    <el-input v-model="dialogForm.createBy"></el-input>
  </el-form-item>
  <el-form-item label="是否匿名">
    <el-input v-model="dialogForm.annoymous"></el-input>
  </el-form-item>
    ...
    <el-col :span="11">
      <el-date-picker type="date" placeholder="选择日期" v-model="dialogForm.createTime" style="width: 100%;">
        ...
        >
          ...
          >
          <el-form-item label="投票主题">
    <el-input v-model="dialogForm1.title"></el-input>
  </el-form-item>
  <el-form-item label="描述">
    <el-input v-model="dialogForm1.description"></el-input>
  </el-form-item>
  <el-form-item label="图片">
    <el-input v-model="dialogForm1.imgUrl"></el-input>
  </el-form-item>
  <el-form-item label="投票发起人">
    <el-input v-model="dialogForm1.createBy"></el-input>
  </el-form-item>
  <el-form-item label="是否匿名">
    <el-input v-model="dialogForm1.annoymous"></el-input>
  </el-form-item>
  <el-form-item label="被投总票数">
    <el-input v-model="dialogForm1.num"></el-input>
  </el-form-item>
  ...
  export default {
    ...
    created() {
        ...
        mounted() {
          //渲染表格数据
          const that = this
          this.$axios.get("http://localhost:8086/vote/select", {
          })
  ...
  getii(row) {
    const that = this
      ...
      add() {
                ...
                this.$axios.post("http://localhost:8086/vote/add", this.dialogForm
                )
                  .then(function (response) {
                    console.log(response);
      ...
      update() {
             ...
             this.$axios.post("http://localhost:8086/vote/update", this.dialogForm1
             )
               .then(function (response) {
                 console.log(response);
           ...
           del(id){
               ...
               //  const id = scope.row.id
                this.$axios.post("http://localhost:8086/vote/delete"+id, {}
                )
                  .then(function (response) {
                    console.log(response);
                    alert("删除成功")
        ...
        form.append('title', this.listQuery.title)
        
        this.$axios.post("http://localhost:8086/vote/search", form)
          .then(function (response) {
